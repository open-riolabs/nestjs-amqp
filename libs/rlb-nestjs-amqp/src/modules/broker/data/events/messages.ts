...
export type ActionPayload<Payload = any> = { action: string; payload: Payload; };
export type TopicEventHandler<Payload = any> = (event: BrokerEvent<Payload>) => void | Promise<void> | Observable<void>;
export type RpcEventHandler<Payload = any, Response = any> = (event: BrokerEvent<Payload>) => Response | Promise<Response> | Observable<Response>;
