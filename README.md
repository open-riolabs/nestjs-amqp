...
***REMOVED******REMOVED*** Basic setup

***REMOVED******REMOVED******REMOVED*** `AppModule`
...
***REMOVED******REMOVED******REMOVED*** Bootstrap
...
***REMOVED******REMOVED*** Minimal `config.yaml`

```yaml
***REMOVED*** yaml-language-server: $schema=./schema.json
...
***REMOVED******REMOVED******REMOVED*** RPC handler with decorators
...
***REMOVED******REMOVED******REMOVED*** RPC call from code
...
***REMOVED******REMOVED******REMOVED*** Manual consumer (without decorators)
...
***REMOVED******REMOVED******REMOVED*** `BrokerService`
...
***REMOVED******REMOVED******REMOVED*** Topic types (`topics[].mode`)
...
***REMOVED******REMOVED******REMOVED*** Decorators
...
***REMOVED******REMOVED******REMOVED*** `@BrokerParam` sources
...
***REMOVED******REMOVED******REMOVED*** `gateway.paths[].dataSource`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Type: `jwks`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Type: `jwt`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Type: `str-compare`
...
***REMOVED******REMOVED******REMOVED*** Gateway path (RPC)
